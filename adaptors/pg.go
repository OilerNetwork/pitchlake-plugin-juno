...
func (p *PostgresAdapter) DepositOrWithdraw(event core.Event) (string, models.BigInt, models.BigInt) {
...
func (p *PostgresAdapter) RoundDeployed(event core.Event) models.OptionRound {
...
func (p *PostgresAdapter) AuctionStarted(event core.Event) (models.BigInt, models.BigInt) {
...
func (p *PostgresAdapter) AuctionEnded(event core.Event) (models.BigInt, models.BigInt, models.BigInt, models.BigInt) {
...
func (p *PostgresAdapter) RoundSettled(event core.Event) (models.BigInt, models.BigInt) {
...
func (p *PostgresAdapter) BidAccepted(event core.Event) models.Bid {
